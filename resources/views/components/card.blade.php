...
<div class="p-10 m-12 rounded-[2vw] border-2 border-[#C5C2C3] w-100  ">
  <div class="flex place-content-between">
    <div class="bg-opacity-30 bg-[#00D1B21A] rounded-full w-12 h-12 p-2 flex justify-center items-center mb-8">
      @if (trim($slot) === '')
      <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="black" class="" viewBox="0 0 16 16">
      <path
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-caret-right"
      viewBox="0 0 16 16">
      <path
  ...
  <p class="font-gabarito font-extrabold text-lg">{{ $cardTitle  }}</p>
  <p class="text-[#7A7A7B] font-gabarito">{{ $cardDescription }}</p>
</div>
